...
For training the model on the dataset, we observed the performance of the pre-trained models of VGG 16 and used transfer learning by modifying the fully connected (FC) layers of the neural network.
